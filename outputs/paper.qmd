...
format: pdf
date: "today"
thanks: "Code and data from this analysis are available at: https://github.com/hari-lr/The-Limits-of-Data-Interpretation. Thank you to Sehar Bajwa for your valuable insights and constructive feedback during the review process."
bibliography: references.bib
---

## Introduction

  The question of how much we should let the data speak for themselves remains a topic of significant debate and contemplation. Drawing insights from the works of Jordan [@JordanPaper], D’Ignazio and Klein [@CatherineBook] and Au [@AuPaper], this paper explores the balance between allowing data autonomy and the necessity for interpretative guidance.
...
In the article "Artificial Intelligence–The Revolution Hasn’t Happened Yet" [@JordanPaper], Michael I. Jordan argues that the reliance on data analysis without attention to provenance is a critical issue that extends beyond individual medical care. He emphasizes the need for a deeper understanding of where the data originates, the inferences drawn from it, and the relevance of those inferences to the present situation. 
  ...
  Lastly, the article "Data Cleaning IS Analysis, Not Grunt Work" complements and extends the ideas presented in The Numbers Don’t Speak for Themselves. Both readings emphasize the importance of critical thinking and human perspective in the data analysis process. Randy Au's article aligns with this perspective by highlighting that data cleaning involves making value judgments and interpretations, reinforcing the idea that data, in its raw form, cannot speak for itself. A notable point is the emphasis on data cleaning as preferential transformations; this suggests that rather than relying solely on raw data, it's essential to recognize and address biases through meticulous data cleaning processes. This not only enhances the reliability of the data but also improves the quality of subsequent analyses. Moreover, Au's article indirectly highlights the human role in data cleaning, suggesting that, despite advancements in AI, certain aspects of data analysis, such as cleaning and interpretation, still require human expertise.
  
## Conclusion
  Based on these readings, I believe that the point at which we should let the numbers speak for themselves is when we want to make applications outside of context, without fully understanding the factors surrounding the provenance of the data. It is important to understand that we cannot generalize data, as each dataset is unique and influenced by various factors. Specifically, when there is, as Jordan puts it, a lack of transparency regarding the provenance of the data [@JordanPaper]. Similarly, D'Ignazio and Klein argue that raw data is not truly raw; it's already manipulated from its collection and measurement. Therefore, even with clear provenance, inherent biases in the data still exist. The way Randy approaches it, suggests that data manipulation in any form involves human input, especially critical and analytical thinking [@AuPaper]. So, considering his perspective, I reiterate that data shouldn't speak for itself to generalize outcomes or trends. 
